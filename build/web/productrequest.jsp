...
<div id="page">
  <div id="container">
	...
	String sql2="select * from products where adminstatus = 'Waiting'"; 
	...
	while(rs2.next())
	{
		...
		%>
            ...
            <br/><br/>
            <table width="631" border="1.5" align="left"  cellpadding="0" cellspacing="0"  >
            <tr>
            ...
            <td  width="115" valign="baseline" height="0" style="color: #2c83b0;"><div align="center">
            <strong>Provider </strong></div></td>
            <td  width="115" valign="baseline" height="0" style="color: #2c83b0;"><div align="center">
            <strong>Status </strong></div></td>
            <td  width="115" valign="baseline" height="0" style="color: #2c83b0;"><div align="center">
        ...
        <td><div align="center"><font color="black"><textarea rows="3" cols="12" readonly=""><%out.println(s2);%></textarea></div></td>
        ...
        <td  width="93" height="110" align="center" valign="middle"><div align="center"><font color="black"><%out.println(s6);%></div></td>
        <td  width="93" height="110" align="center" valign="middle"><div align="center"><font color="black"><%out.println(s7);%></div></td>
        <td  width="93" height="110" align="center" valign="middle"><div align="center"> <button type="button"><a href="approveproduct.jsp?pname=<%=s1%>&provider=<%=s6%>"><font color="red"> Approve </font></a></button> </div></td>
